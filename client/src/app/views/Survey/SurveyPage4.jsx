            ...
            <TableBody>
              <TableRow style={{ justifyContent: "space-evenly" }}>
                <TableCell className="px-0" colspan="8">
                  <b>
                    <font size="4">
                      16. You have noticed that the call to action for climate change 
                      has fallen short of your expectations and want to do more.
                    </font>
                  </b>
                </TableCell>
              ...
              <TableRow style={{ justifyContent: "space-evenly" }}>
                <TableCell className="px-0" colspan="8">
                  <b>
                    <font size="4">
                      17. You are often concerned about ocean life 
                      and want to help reduce our negative impacts on the ocean.
                    </font>
                  </b>
                </TableCell>
                <TableCell className="px-0" colspan="11">
              ...
              <TableRow style={{ justifyContent: "space-evenly" }}>
                <TableCell className="px-0" colspan="8">
                  <b>
                    <font size="4">
                      18. You are often concerned about life on land and 
                      want to help reduce our negative impacts on the affected ecosystems.
                    </font>
                  </b>
                </TableCell>
                <TableCell className="px-0" colspan="11">
              ...
              <TableRow style={{ justifyContent: "space-evenly" }}>
                <TableCell className="px-0" colspan="8">
                  <b>
                    <font size="4">
                      20. You want to get involved with each of 
                      the implimentations of the Sustainable Development Goals.
                    </font>
                  </b>
                </TableCell>
                <TableCell className="px-0" colspan="11">
